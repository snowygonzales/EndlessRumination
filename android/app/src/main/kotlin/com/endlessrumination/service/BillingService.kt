...
class BillingService(
    ...
    val ownedPackIDs: Set<String> get() = _ownedPackIDs.toSet()
    ...
    suspend fun loadProducts(): com.endlessrumination.service.BillingResult {
    ...
    suspend fun checkEntitlements(): RestoreResult = restorePurchases()

    suspend fun getReceiptForServer(): ReceiptPayload? = lastReceiptPayload
