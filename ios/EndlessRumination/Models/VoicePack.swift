...
extension VoicePack {
    static let all: [VoicePack] = [
        ...
        VoicePack(
            ...
            voices: [
                VoicePackVoice(id: 20, name: "Dale Carnegie", years: "1888–1955", emoji: "🤝", color: Color(hex: 0xC9A84C), bgColor: Color(hex: 0xC9A84C).opacity(0.15), desc: "The master of human relations. Turns your worry into a lesson on winning friends and defusing conflict.", sampleHeadline: "You're worrying about the wrong side of this conversation.", sampleBody: "People will forgive almost anything if you make them feel important. The remedy isn't the apology — it's what you say next."),
                VoicePackVoice(id: 21, name: "Machiavelli", years: "1469–1527", emoji: "🐍", color: Color(hex: 0x8B4513), bgColor: Color(hex: 0x8B4513).opacity(0.15), desc: "Cold strategic reframing. Every interpersonal problem is a power dynamics puzzle.", sampleHeadline: "Your error was not the email — it was showing your hand.", sampleBody: "A prince who reveals displeasure gives others power over his emotions. The remedy is to become so formidable that this person will one day wish they had acted differently."),
                VoicePackVoice(id: 22, name: "Sun Tzu", years: "544–496 BC", emoji: "🏯", color: Color(hex: 0xD4A843), bgColor: Color(hex: 0xD4A843).opacity(0.15), desc: "Every worry reframed as a battlefield. Ancient strategy applied to modern problems.", sampleHeadline: "The battle is lost. Withdraw and prepare the next campaign.", sampleBody: "The wise general does not reinforce failure. Study what intelligence you gathered from this defeat. The next battle will be fought on ground of your choosing."),
                VoicePackVoice(id: 23, name: "Benjamin Franklin", years: "1706–1790", emoji: "🪁", color: Color(hex: 0x6E9FFF), bgColor: Color(hex: 0x6E9FFF).opacity(0.15), desc: "The original life-hacker. Pragmatic wit meets systematic self-improvement.", sampleHeadline: "I once made a list of my virtues and failed every one by Tuesday.", sampleBody: "Take a fresh sheet and draw a line down the middle. On the left, every consequence you fear. On the right, the probability of each. Your imagination has been a far crueler correspondent than reality."),
                VoicePackVoice(id: 24, name: "P.T. Barnum", years: "1810–1891", emoji: "🎪", color: Color(hex: 0xFF6B9D), bgColor: Color(hex: 0xFF6B9D).opacity(0.15), desc: "The greatest showman. Every disaster is just the opening act of a better story.", sampleHeadline: "My dear friend, you haven't failed — you've created a spectacle!", sampleBody: "The public loves a comeback more than they ever loved a smooth beginning. Every great success I ever had began with a moment that looked exactly like this one."),
            ]
        ),
        ...
        VoicePack(
            ...
            voices: [
                VoicePackVoice(id: 30, name: "Immanuel Kant", years: "1724–1804", emoji: "📐", color: Color(hex: 0xB08AFF), bgColor: Color(hex: 0xB08AFF).opacity(0.15), desc: "The categorical imperative applied to your problems. Rigorous moral reasoning meets daily worry.", sampleHeadline: "Could you universalize sending that email? Then you must not.", sampleBody: "Your own reason tells you this was wrong, and that recognition is itself the proof of your moral capacity. Act now from duty, not inclination."),
                VoicePackVoice(id: 31, name: "Nietzsche", years: "1844–1900", emoji: "⚡", color: Color(hex: 0xFF6B9D), bgColor: Color(hex: 0xFF6B9D).opacity(0.15), desc: "Life-affirming through suffering. Challenges weakness of spirit with fierce love.", sampleHeadline: "Amor fati — love your fate, including this humiliation.", sampleBody: "You are suffering because you glimpsed who you became in that moment and it revolted you. This revulsion is the sign of ascending life, not declining."),
                VoicePackVoice(id: 32, name: "Kierkegaard", years: "1813–1855", emoji: "😰", color: Color(hex: 0x4A7CFF), bgColor: Color(hex: 0x4A7CFF).opacity(0.15), desc: "THE philosopher of anxiety. Wrote the book on dread. Deeply relevant to rumination.", sampleHeadline: "Your anxiety is not a symptom — it is the dizziness of your freedom.", sampleBody: "This dread you feel is not punishment. It is the proof that you are a self in the process of becoming. Only those who choose wrongly and feel the wound can choose rightly next time."),
                VoicePackVoice(id: 33, name: "Epictetus", years: "50–135 AD", emoji: "⛓️", color: Color(hex: 0x40DFB0), bgColor: Color(hex: 0x40DFB0).opacity(0.15), desc: "Stoicism forged in slavery. Not armchair philosophy — wisdom from lived suffering.", sampleHeadline: "You are disturbed not by the email but by your judgment of it.", sampleBody: "What remains in your control? Your response to this moment. That is the entirety of your domain. Stop rehearsing a past you cannot reach."),
                VoicePackVoice(id: 34, name: "Lao Tzu", years: "~6th c. BC", emoji: "☯️", color: Color(hex: 0x8A8690), bgColor: Color(hex: 0x8A8690).opacity(0.15), desc: "Taoist non-action. The paradoxical wisdom of going with the flow.", sampleHeadline: "The reed that bends in the wind does not break.", sampleBody: "Your path forward is not to fight the current of regret — it is to stop swimming upstream and let the river carry you to where you are meant to go."),
            ]
        ),
